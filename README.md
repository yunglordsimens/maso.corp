...
🔗 **[Print Production Tool direct link](https://yunglordsimens.github.io/maso.corp/guide)**
...
<table style="border: none; width: 100%;">
  <tr>
    <td width="50%" valign="top">
      ...
      <p align="center" style="font-size: 11px; font-family: monospace;">Simulated security protocols & IP tracking.</p>
      <img src="./preview_login.png" width="100%" style="border: 1px solid #ccc;">
    </td>
    <td width="50%" valign="top">
  ...
  <tr>
    <td colspan="2" valign="top">
      ...
      <p align="center" style="font-size: 11px; font-family: monospace;">Automated flatplan renderer & imposition viewer for print materials.</p>
      <img src="./preview_guide.png" width="100%" style="border: 1px solid #ccc;">
    </td>
  </tr>
</table>
